...
//                return ['<a href="' + helpers.leagueUrl(["team_finances", t.abbrev]) + '">' + t.region + ' ' + t.name + '</a>', helpers.formatCurrency(t.cash, ""), t.hype,t.teamConf];
//                return ['<a href="' + helpers.leagueUrl(["team_finances", t.abbrev]) + '">' + t.region + ' ' + t.name + '</a>', helpers.formatCurrency(t.cash, ""), t.hype,t.hype];
//                return ['<a href="' + helpers.leagueUrl(["team_finances", t.abbrev]) + '">' + t.region + ' ' + t.name + '</a>', helpers.formatCurrency(t.cash, ""), t.teamConf,t.teamConf];
