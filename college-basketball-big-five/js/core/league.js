...
define(["dao", "db", "globals", "ui", "core/draft", "core/finances", "core/player", "core/season", "core/team", "lib/bluebird", "lib/jquery", "lib/underscore", "util/helpers", "util/random"], function (dao, db, g, ui, draft, finances, player, season, team, Promise, $, _, helpers, random) {
    ...
    function create(name, tid, leagueFile, startingSeason, randomizeRosters) {
       ...
       /* for (i = 0; i < teams.length; i++) {
			teams[i].hype = teams[i].pop;
        }		*/
	//	console.log(teams[0].tid);
	//	console.log(teams[0].did);
	//	console.log(teams[0].cid);
...
//							adjustment = -30;
					...
					//		console.log(t2+ " "+adjustment);
							...
							//// top and bottom division adjustment
							if (t2<4) {
							   adjustment += 5;
							} else if (t2<8) {
							   adjustment += -5;							
...
//							exportedLeague[store] = contentFiltered;
			  ...
			  var ratingsToArray,numDraftClass,j;
			  //players.sort(function (a, b) {  return b.stats.ewa - a.stats.ewa; });
				...
				//console.log(exportedLeague.players[i].awards.length);
//				  if (exportedLeague.players[i].awards.length>0) {
				  ...
				  exportedLeague.players[i].ratings.stre *= 1.5;
				//  exportedLeague.players[i].ratings.hgt *= 1.5;
				  exportedLeague.players[i].ratings.fg *= 1.5;
				  exportedLeague.players[i].ratings.spd *= 1.5;				  
				  exportedLeague.players[i].ratings.dnk *= 1.5;
				  exportedLeague.players[i].ratings.jmp *= 1.5;
				  exportedLeague.players[i].ratings.ins *= 1.5;
				  exportedLeague.players[i].ratings.endu *= 1.5;
				  exportedLeague.players[i].ratings.ft *= 1.5;
				  exportedLeague.players[i].ratings.tp *= 1.5;
				  exportedLeague.players[i].ratings.blk *= 1.5;
				  exportedLeague.players[i].ratings.stl *= 1.5;
				  exportedLeague.players[i].ratings.drb *= 1.5;
				  exportedLeague.players[i].ratings.pss *= 1.5;
				  exportedLeague.players[i].ratings.reb *= 1.5;
				  
				  exportedLeague.players[i].ratings.pot *= 1.5;
				  
				  exportedLeague.players[i].ratings.stre -= 75;
				//  exportedLeague.players[i].ratings.hgt -= 75;
				  exportedLeague.players[i].ratings.fg -= 75;
				  exportedLeague.players[i].ratings.spd -= 75;
				  exportedLeague.players[i].ratings.dnk -= 75;
				  exportedLeague.players[i].ratings.jmp -= 75;
				  exportedLeague.players[i].ratings.ins -= 75;
				  exportedLeague.players[i].ratings.endu -= 75;
				  exportedLeague.players[i].ratings.ft -= 75;
				  exportedLeague.players[i].ratings.tp -= 75;
				  exportedLeague.players[i].ratings.blk -= 75;
				  exportedLeague.players[i].ratings.stl -= 75;
				  exportedLeague.players[i].ratings.drb -= 75;
				  exportedLeague.players[i].ratings.pss -= 75;
				  exportedLeague.players[i].ratings.reb -= 75;
				 ...
				 if (exportedLeague.players[i].ratings.pot < 0) {
				  ...
				  if (exportedLeague.players[i].ratings.pot<40) {
