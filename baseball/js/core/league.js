...
// baseball	
     ...
     */
    function create(name, tid, posid, leagueFile, startingSeason, randomizeRosters) {
...
//                        var afterPlayerCreation, age, agingYears, baseRatings, cbAfterEachPlayer,  draftYear, goodNeutralBad, i, j, n, numLeft, p, pg, players, pots, profile, profiles, randomizeExpiration, simpleDefaults, t, t2, playerTids;
                        var agingYears, agingYears2, baseRatings,  draftYear, goodNeutralBad, i, j, n, numLeft, p, players, pots, profile, profiles, randomizeExpiration, t, t2, playerTids;
                   ...
                   /*     afterPlayerCreation = function () {
                           ...
                           tx = g.dbl.transaction(["players", "playerStats"], "readwrite");
                            ...
                            // See if imported roster has draft picks included. If so, create less than 175 (scaled for number of teams)
...
//                            profiles = ["Point", "Wing", "Big","Big","Fielder", "Big","Power", "Big","Speed", "Big","Catcher", "Big", ""];
//                            profiles = ["Point","Catcher"]; C
//                            profiles = ["Point","Speed"]; CF
//                            profiles = ["Point","Power"]; LF
//                            profiles = ["Point","Power2"]; 1B
//                            profiles = ["Hitter","Fielder","Power","Power2","Speed","Catcher","Short","Third","Right","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher"]; 
                            profiles = ["Fielder","Power","Power2","Speed","Catcher","Short","Third","Right","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher","Pitcher"]; 
//                            profiles = ["Big"];
                            baseRatings = [37, 37, 36, 35, 34, 33, 32, 31, 30, 29, 28, 26, 26, 26,37, 37, 36, 35, 34, 33, 32, 31, 30, 29, 28, 26, 26, 26,37, 37, 36, 35, 34, 33, 32, 31, 30, 29, 28, 26, 26, 26];
                            pots = [75, 65, 55, 55, 60, 50, 70, 40, 55, 50, 60, 60, 45, 45,75, 65, 55, 55, 60, 50, 70, 40, 55, 50, 60, 60, 45, 45,75, 65, 55, 55, 60, 50, 70, 40, 55, 50, 60, 60, 45, 45];

//                            numLeft = 33 * 14;
                            // roster size  numLeft = teams*(rostersize-1);
							// n goes to roster size
...
//                                    agingYears = random.randInt(0, 15);
//                                    agingYears2 = random.randInt(0, 15);									
                                    agingYears = random.randInt(0, 19);
                                  //  agingYears2 = random.randInt(0, 19);									
//									if ( (agingYears2 < agingYears) && (Math.random() < .5) ) {
									//if ( (agingYears2 < agingYears)  ) {
//										agingYears = agingYears2;
	///								}
									let agingYearsAdjustment = 0;
									if (agingYears < 10) {
										agingYearsAdjustment = -10;
									}
                                    draftYear = g.startingSeason - 1 - agingYears;
									if (t < 0) {
										agingYears += 8;										
										draftYear = g.startingSeason - 1 - agingYears;
										p = player.generate(t2, 19, profile, 20, 20, draftYear, true, scoutingRank);										
									} else {
										p = player.generate(t2, 19, profile, baseRatings[n]+agingYearsAdjustment, pots[n], draftYear, true, scoutingRank);
									}
