    ...
    function updateDraftSummary(inputs, updateEvents, vm) {
        ...
        return dao.players.getAll({
            ...
            playersAll = player.filter(playersAll, {
                ...
                stats: ["gp", "min", "pts", "trb", "ast", "per","fga","wOBA","fta","pf","fgaMidRange","war"],
                showNoStats: true,
                showRookies: true,
                fuzz: true
            });
