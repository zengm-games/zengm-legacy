...
//                        return (b.gs * 1000 + b.min + b.injury.gamesRemaining * 1000) - (a.gs * 1000 + a.min + a.injury.gamesRemaining * 1000);
   ...
   /*             if (game.overtimes === 1) {
               ...
               if (game.overtimes === 1) {
                    game.overtime = " (" + (game.overtimes+9) + ")";
//                    game.overtime = " (OT)";
        //            overtimeList[game.overtimes] = 10;
                } else if (game.overtimes > 1) {
                    game.overtime = " (" + (game.overtimes+9) + ")";
     //               overtimeList[game.overtimes] = game.overtimes+9;					
                } else {
                    game.overtime = "";
                }
 ...
 //           overtimeList: ko.observableArray([]),
			//<!--            <!-- ko foreach: boxScore.overtimes --> -->
    //        overtimes: ko.observable()
        };
