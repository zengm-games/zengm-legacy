...
define(["dao", "globals", "lib/bluebird", "util/helpers", "util/random"], function (dao, g, Promise, helpers, random) {
    ...
    activities = [
      ...
      //  "running my baseball team (baseball is a religion, basketball is a game)",
        ...
        "buying cars and jewelry for middle school hockey prospects so they'll sign here when they turn pro",
     ...
     //   "figuring out how to fit in more courtside seats for celebrities",
        "coming up with a way to slightly shrink or expand the goal, depending on which one we're shooting at",
        "perfecting my money laundering infrastructure (owning this team is very helpful)",
        "thinking about how to move the team to Las Vegas",		
        "thinking about how to move the team to Nashville",		
        "thinking about how to move the team to Columbus",		
        "thinking about how to move the team to Raleigh",		
        "thinking about how to move the team to Toronto",		
        "thinking about how to move the team to New York",				
        "thinking about how to move the team to Los Angeles",		
