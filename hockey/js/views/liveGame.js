    ...
    function updatePlayByPlay(inputs, updateEvents, vm) {
        ...
        if (inputs.playByPlay !== undefined && inputs.playByPlay.length > 0) {
             return dao.games.get({key: inputs.gidPlayByPlay}).then(function (boxScore) {
                ...
                // Stats to set to 0
                resetStats = ["min", "fg", "fga", "tp", "tpa", "ft", "fta", "orb", "trb", "ast", "tov", "stl", "blk", "pf", "pts","plusminus","mfg","fgs","pmin","hits","ppmin","shmin","fow","fol","sfa","sfg","sfgs","sfga"];

                boxScore.overtime = "";
                boxScore.quarter = "1st period";
                boxScore.time = "20:00";
...
//                    if ( (text.indexOf("made") || text.indexOf("scored")) >= 0) {
                    if ((  text.indexOf("scored") || text.indexOf("assist")) >= 0) {
                    ...
                    if (e.s === "pts") {
                        ...
                        if (ptsQtrs.length <= e.qtr) {
                            ...
                            if (ptsQtrs.length > 3) {
                                ...
                                vm.boxScore.quarter(helpers.ordinal(ptsQtrs.length) + " period");
                            }
                        }
                        ptsQtrs[e.qtr] += e.amt;
                    ...
                    } else if (e.s === "min" || e.s === "fg" || e.s === "fga" || e.s === "tp" || e.s === "tpa" || e.s === "ft" || e.s === "fta" || e.s === "ast" || e.s === "tov" || e.s === "stl" || e.s === "blk" || e.s === "pf" || e.s === "pts" || e.s === "pta" || e.s === "plusminus" || e.s === "mfg" || e.s === "fgs" || e.s === "pmin" || e.s === "hits" || e.s === "ppmin" || e.s === "shmin" || e.s === "fow" || e.s === "fol" || e.s === "sfa" || e.s === "sfg" || e.s === "sfgs") {
                        vm.boxScore.teams()[e.t].players()[e.p][e.s](vm.boxScore.teams()[e.t].players()[e.p][e.s]() + e.amt);
                        vm.boxScore.teams()[e.t][e.s](vm.boxScore.teams()[e.t][e.s]() + e.amt);
                    }
                }
