...
define(["dao", "globals", "ui", "core/finances", "core/team", "lib/jquery", "lib/knockout", "lib/underscore", "views/components", "util/bbgmView", "util/helpers"], function (dao, g, ui, finances, team, $, ko, _, components, bbgmView, helpers) {
    ...
    function uiFirst(vm) {
        ...
        $("#help-payroll-limits").popover({
            ...
            content: "The salary cap is a soft cap, meaning that you can exceed it sign players if you have injuries. You can also can exceed the salary cap to sign a free agent for the league minimum. Teams with payrolls below the minimum payroll limit will be assessed a fine equal to the difference at the end of the season."
        });
        ...
        ko.computed(function () {
            ...
            $.barGraph($("#bar-graph-pop"), barData.pop, [0, 6], barSeasons, function (val) {
                return helpers.round(val, 1) + "M";
            });
            $.barGraph($("#bar-graph-att"), barData.att, [0, 21000], barSeasons, function (val) {
