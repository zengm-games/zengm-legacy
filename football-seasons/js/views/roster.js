...
//            if (numPlayersOnRoster <= 5) {
            if (numPlayersOnRoster <= 45) {
                return cb("You must keep at least 45 players on your roster.");
            }
...
//                ratings = ["ovr", "pot", "dovr", "dpot", "skills"];
					ratings = ["ovr", "pot", "hgt","stre","spd","jmp","endu","ins","dnk","ft","fg","tp","blk","stl","drb","pss","reb","hnd","cvr","kck","dovr", "dpot","dovr", "dpot","dhgt", "dstre","dspd","djmp","dendu","dins","ddnk","dft","dfg","dtp","dblk","dstl","ddrb","dpss","dreb","dhnd","dcvr","dkck",  "skills"];
