        ...
        function processToNextPause() {
            ...
            while (!stop && events.length > 0) {
                ...
                if (e.type === "text") {
                    ...
                    if ((text.indexOf("made") >= 0) || (text.indexOf("scored") >= 0) || (text.indexOf("scores") >= 0)) {
                        text += "<b> (" + vm.boxScore.teams()[0].pts() + "-" + vm.boxScore.teams()[1].pts() + ")</b>";
                    }
...
/*                        vm.boxScore.teams()[e.t].players()[e.p].trb(vm.boxScore.teams()[e.t].players()[e.p].trb() + e.amt);
                    ...
                    } else if (e.s === "min" || e.s === "fg" || e.s === "fga" || e.s === "tp" || e.s === "tpa" || e.s === "ft" || e.s === "fta" || e.s === "ast" || e.s === "tov" || e.s === "stl" || e.s === "blk" || e.s === "pf" || e.s === "pts" || e.s === "tgts" || e.s === "ols" || e.s === "olr" || e.s === "olry"  || e.s === "olp"  || e.s === "olpy" || e.s === "olc" || e.s === "dec" || e.s === "der" || e.s === "dery" || e.s === "dep" || e.s === "depy" || e.s === "prp" || e.s === "ty" || e.s === "syl"  || e.s === "tda"  || e.s === "tdf"  || e.s === "fdt" || e.s === "fdp" || e.s === "fdr" || e.s === "rztd" || e.s === "rza" || e.s === "top" || e.s === "inter" || e.s === "intery"  || e.s === "fbl"   || e.s === "olrp"    || e.s === "fldgze"    || e.s === "fldgtw"   || e.s === "fldgth"   || e.s === "fldgfo"   || e.s === "fldgfi"   || e.s === "puntty"   || e.s === "punttb"   || e.s === "fldgzea"   || e.s === "fldgtwa"   || e.s === "fldgtha"   || e.s === "fldgfoa"   || e.s === "fldgfia" || e.s === "puntl" || e.s === "punta") {
                        vm.boxScore.teams()[e.t].players()[e.p][e.s](vm.boxScore.teams()[e.t].players()[e.p][e.s]() + e.amt);
                        vm.boxScore.teams()[e.t][e.s](vm.boxScore.teams()[e.t][e.s]() + e.amt);
                    } 
				}
        ...
        if (inputs.playByPlay !== undefined && inputs.playByPlay.length > 0) {
            ...
            g.dbl.transaction("games").objectStore("games").get(inputs.gidPlayByPlay).onsuccess = function (event) {
                ...
                // Stats to set to 0
                resetStats = ["min", "fg", "fga", "tp", "tpa", "ft", "fta", "orb", "trb", "ast", "tov", "stl", "blk", "pf", "pts","tgts", "ols", "olr", "olp", "olry", "olpy", "olc", "oltd", "der", "dep", "dery", "depy", "dec", "detd","prp","drb","ty","syl","tdf","tda","fdt","fdp","fdr","rztd","rza","top","inter","intery","fbl","olrp",'fldgze','fldgtw','fldgth','fldgfo','fldgfi','puntty','punttb','fldgzea','fldgtwa','fldgtha','fldgfoa','fldgfia','puntl','punta'];
