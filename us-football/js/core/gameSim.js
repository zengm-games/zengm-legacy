		...
		for ( t = 0; t < 2; t++) {
			...
			for ( pp = 0; pp < this.playersOnCourt[t].length; pp++) {
				...
				for ( b = 0; b < this.team[t].player.length; b++) {
					...
					//         console.log(t);
					//        console.log(b);
					//      console.log(this.team[t].player[b].active);
					//      console.log(this.playersOnCourt[t].indexOf(b));
					//      console.log(this.team[t].player[p].stat.courtTime);
					//     console.log(this.team[t].player[b].stat.benchTime);
					//    console.log(this.team[t].player[b].injured);
					//   console.log(this.team[t].player[p].injured);
					//   console.log(this.team[t].player[b].pos);
					//  console.log(this.team[t].player[p].pos);
					//  console.log(ovrs[p]);
					//  console.log(ovrs[b]);
