...
define(["db", "globals", "core/player", "core/team", "lib/underscore"], function (db, g, player, team, _) {
    ...
    function makeItWork(teams, holdUserConstant, estValuesCached, cb) {
        ...
        added = 0;
//		console.log("got here , added: "+added);
	...
	//	console.log("got here c in");
		...
		console.log("pick push");							
                        } else {
                            otherDpids.push(assets[i].dpid);
		console.log("pick push");							
                        }
                    }
					console.log("got here after pushing");
                    (function (i) {
			...
			//		console.log("valueChange");
					...
					console.log("done"+done);
                                ...
                                added += 1;
		console.log("got here adding, added: "+added);
                                testTrade();
                            }
                        });
