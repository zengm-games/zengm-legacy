        ...
        try {
            g.dbm.transaction("leagues").objectStore("leagues").getAll().onsuccess = function (event) {
                ...
                vm.onSubmit = function () {
                    ...
                    objectStores = ["players", "releasedPlayers", "awards", "teams", "schedule", "playoffSeries", "playoffSeries64", "draftPicks", "trade", "negotiations", "gameAttributes", "draftOrder", "messages", "events"];
