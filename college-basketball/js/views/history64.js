    ...
    function updateHistory(inputs, updateEvents, vm) {
        if (updateEvents.indexOf("dbChange") >= 0 || updateEvents.indexOf("firstRun") >= 0 || vm.season() !== inputs.season) {
			...
			//	   console.log("i: "+i+" teams[i].playoff64RoundsWon: "+teams[i].playoff64RoundsWon+" finalfour: "+finalfour);
					...
					if (teams[i].playoff64RoundsWon === 4+g.gameType) {
                        runnerUp64 = teams[i];
                   //     break;
                    }					
					if ((teams[i].playoff64RoundsWon === 3+g.gameType) && (finalfour === 0)) {
					    finalfour += 1;
                        finalfour1 = teams[i];
                   //     break;
                    } else  if ((teams[i].playoff64RoundsWon === 3+g.gameType) && (finalfour === 1)) {
					    finalfour += 1;					
                        finalfour2 = teams[i];
                   //     break;
                    }					
					if ((teams[i].playoff64RoundsWon === 2+g.gameType) && (eliteeight === 0)) {
					    eliteeight += 1;
                        eliteeight1 = teams[i];
                   //     break;
                    } else  if ((teams[i].playoff64RoundsWon === 2+g.gameType) && (eliteeight === 1)) {
					    eliteeight += 1;					
                        eliteeight2 = teams[i];
                   //     break;
                    } else  if ((teams[i].playoff64RoundsWon === 2+g.gameType) && (eliteeight === 2)) {
					    eliteeight += 1;					
                        eliteeight3 = teams[i];
                    } else  if ((teams[i].playoff64RoundsWon === 2+g.gameType) && (eliteeight === 3)) {
					    eliteeight += 1;					
                        eliteeight4 = teams[i];
                    }					
					
					if ((teams[i].playoff64RoundsWon === 1+g.gameType) && (sweet === 0)) {
					    sweet += 1;
                        sweet1 = teams[i];
                   //     break;
                    } else  if ((teams[i].playoff64RoundsWon === 1+g.gameType) && (sweet === 1)) {
					    sweet += 1;					
                        sweet2 = teams[i];
                   //     break;
                    } else  if ((teams[i].playoff64RoundsWon === 1+g.gameType) && (sweet === 2)) {
					    sweet += 1;					
                        sweet3 = teams[i];
                    } else  if ((teams[i].playoff64RoundsWon === 1+g.gameType) && (sweet === 3)) {
					    sweet += 1;					
                        sweet4 = teams[i];
                    } else  if ((teams[i].playoff64RoundsWon === 1+g.gameType) && (sweet === 4)) {
					    sweet += 1;					
                        sweet5 = teams[i];
                    } else  if ((teams[i].playoff64RoundsWon === 1+g.gameType) && (sweet === 5)) {
					    sweet += 1;					
                        sweet6 = teams[i];
                    } else  if ((teams[i].playoff64RoundsWon === 1+g.gameType) && (sweet === 6)) {
					    sweet += 1;					
                        sweet7 = teams[i];
                    } else  if ((teams[i].playoff64RoundsWon === 1+g.gameType) && (sweet === 7)) {
					    sweet += 1;					
                        sweet8 = teams[i];
                    }										
