    ...
    function updateRoster(inputs, updateEvents, vm) {
        ...
        if (updateEvents.indexOf("dbChange") >= 0 || (inputs.season === g.season && (updateEvents.indexOf("gameSim") >= 0 || updateEvents.indexOf("playerMovement") >= 0)) || inputs.abbrev !== vm.abbrev() || inputs.season !== vm.season()) {
            ...
            return team.filter({
                ...
                attrs = ["pid", "tid", "draft", "name", "pos","year","age", "contract", "cashOwed", "rosterOrder", "injury", "ptModifier", "watch","city","state","miles", "gamesUntilTradable"];  // tid and draft are used for checking if a player can be released without paying his salary
