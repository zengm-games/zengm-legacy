               ...
               teams.forEach(function (t) {
                ...
                teams.forEach(function (t) {
                    ...
                    for (i = 0; i < seasons.length; i++) {
                        ...
                        if ((t.seasons[j].playoffRoundsWon === 4) && (userCid == true ))  {
                            seasons[i].champ = {
                                tid: t.tid,
//                                cid: t.cid,
                                abbrev: t.abbrev,
                        ...
                        } else if ((t.seasons[j].playoffRoundsWon === 3) && (userCid == true ))  {
                            seasons[i].runnerUp = {
                                abbrev: t.abbrev,
                                region: t.region,
                                name: t.name,
                ...
                for (i = 0; i < seasons.length; i++) {
			//	    console.log("seasons[i].champ: "+seasons[i].champ);
                    if (seasons[i].champ) {
				...
				//    console.log("seasons[i].champ.count: "+seasons[i].champ.count);
                }
    ...
    function uiFirst(vm) {
        ...
        ui.title("Conference Tournaments and Regular Season History");
...
//                return [seasonLink,awardName(s.mvp, s.season), awardName(s.dpoy, s.season), awardName(s.roy, s.season)];
                return [seasonLink,teamName(s.champ, s.season)+ countText, teamName(s.runnerUp, s.season),awardName(s.mvp, s.season), awardName(s.dpoy, s.season), awardName(s.roy, s.season)];
