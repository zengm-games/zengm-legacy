...
define(["dao", "globals", "lib/knockout", "util/eventLog"], function (dao, g, ko, eventLog) {
    ...
    function getTeamsDefault() {
        ...
        teams = [
            ...
            {tid: 297, cid: 18, did: 37, region: "Allentown", name: "Valley", abbrev: "ALLE", pop: 23, city: "Hamilton", state: "PA", latitude: 40.608 , longitude: -75.49},		
            {tid: 298, cid: 18, did: 37, region: "Erie", name: "Flagship", abbrev: "ERIE", pop: 22, city: "Hamilton", state: "PA", latitude: 42.129 , longitude: -80.085},		
            {tid: 299, cid: 18, did: 37, region: "Reading", name: "Pretzel", abbrev: "READ", pop: 21, city: "Hamilton", state: "PA", latitude: 40.336 , longitude: -75.927},		
            {tid: 300, cid: 18, did: 37, region: "Scranton", name: "Federal", abbrev: "SCRA", pop: 20, city: "Hamilton", state: "PA", latitude: 41.409 , longitude: -75.665},		
            {tid: 301, cid: 18, did: 37, region: "Bethlehem", name: "Moravians", abbrev: "BETH", pop: 19, city: "Hamilton", state: "PA", latitude: 40.626 , longitude: -75.37},		
            {tid: 302, cid: 18, did: 37, region: "Lancaster", name: "Pennsylvania Dutch", abbrev: "LANC", pop: 18, city: "Hamilton", state: "PA", latitude: 40.038 , longitude: -76.306},		
...
//            {tid: 0, cid: 0, did: 2, region: "Atlanta", name: "Gold Club", abbrev: "ATL", pop: 4.3},
       //     {typeid: 0, teams: 20, tour: 4, name: "20 teams, 4 team tournament, 5 conferences"},
            {typeid: 0, teams: 80, tour: 5, name: "80 teams, 32 team playoffs, 5 conferences"},
            {typeid: 1, teams: 320, tour: 20, name: "320 teams, 64 team playoffs, 20 conferences"}
        ];
    ...
    function bbgmPing(type) {
        if (g.enableLogging) {
            ...
            if (type === "league") {
                _gaq.push(["_trackEvent", "College Basketball"+typeText, "New league", g.lid.toString()]);
            } else if (type === "season" && g.autoPlaySeasons === 0) {
                _gaq.push(["_trackEvent", "College Basketball"+typeText, "Completed season", g.season.toString()]);
            }
        }
    }
...
/*                    gSend = JSON.parse(JSON.stringify(g)); // deepCopy fails for some reason
    ...
    return {
        ...
        getTeams80Default: getTeams80Default,
        getTeams320Default: getTeams320Default,		
