...
//        slug: "sleeper_pick",
    ...
    checkAchievement.fo_fo_fo = function (saveAchievement) {
		...
		return team.filter({
            ...
            if ((t.playoffRoundsWon === 4 ) && (t.playoff64RoundsWon === neededRounds )) {
                if (saveAchievement) {
...
//                            addAchievements(["98_degrees"]);
    ...
    function checkDynasty(titles, years, slug, saveAchievement) {
        ...
        return dao.teams.get({key: g.userTid}).then(function (t) {
            var i, titlesFound, neededRounds;
            ...
            for (i = 0; i < years; i++) {
                ...
                if (t.seasons[t.seasons.length - 1 - i].playoff64RoundsWon === neededRounds) {
                    titlesFound += 1;
                }
            }
...
//        return checkMoneyball(4, "moneyball", saveAchievement);
        if ( g.gameType == 0)  {
			return checkMoneyball(3, "final_four", saveAchievement);			
		} else {
...
//        return checkMoneyball(3, "moneyball_2", saveAchievement);
        if ( g.gameType == 0)  {
			return checkMoneyball(2, "elite_eight", saveAchievement);			
		} else {
...
//                    addAchievements(["small_market"]);
    ...
    checkAchievement.sleeper_pick = function (saveAchievement) {
       ...
       return team.filter({
            ...
            if ((t.playoff64RoundsWon === 6 && g.gameType == 1) || (t.playoff64RoundsWon === 5 && g.gameType == 0))  {
                if (saveAchievement) {
