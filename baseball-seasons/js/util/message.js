...
define(["dao", "globals", "util/helpers", "util/random"], function (dao, g, helpers, random) {
    ...
    activities = [
        ...
        "running my basketball team (it actually wins)",
        "trying to patent the gene for height so I can sue our competition to pieces",
        "bribing the commissioner to let me ump our games",
        "bribing the commissioner to rig the draft for us",
        "buying cars and jewelry for middle school baseball prospects so they'll sign here when they turn pro",
        ...
        "coming up with a way to slightly shrink or expand the outfield, depending on when we are hitting",
    ...
    ovr[1] = [
        "You bore me. Everything about you, it's just boring. Come talk to me when you've earned me more millions and won me some more rings.",
