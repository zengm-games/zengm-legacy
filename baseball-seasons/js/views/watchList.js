    ...
    function uiFirst(vm) {
        ...
        ko.computed(function () {
            ...
            for (i = 0; i < vm.players().length; i++) {
                ...
                rows.push([helpers.playerNameLabels(p.pid, p.name, p.injury, p.ratings.skills, p.watch), p.pos, String(p.age), '<a href="' + helpers.leagueUrl(["roster", p.abbrev]) + '">' + p.abbrev + '</a>', String(p.ratings.ovr), String(p.ratings.pot), contract]);
            }
