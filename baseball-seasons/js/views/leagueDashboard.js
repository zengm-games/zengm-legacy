        ...
        if (updateEvents.indexOf("dbChange") >= 0 || updateEvents.indexOf("firstRun") >= 0 || updateEvents.indexOf("gameSim") >= 0 || updateEvents.indexOf("playerMovement") >= 0 || updateEvents.indexOf("newPhase") >= 0) {
            ...
            return dao.players.getAll({
                ...
                players = player.filter(players, {
                    attrs: ["pid", "name", "abbrev", "tid", "age", "contract", "rosterOrder", "injury", "watch", "pos","energy","offDefK","active", "yearsWithTeam"],
//                    ratings: ["ovr", "pot", "dovr", "dpot", "skills"],
                    ratings: ["ovr", "pot", "hgt","stre","spd","jmp","endu","ins","dnk","ft","fg","tp","blk","stl","drb","pss","reb","dovr", "dpot","dhgt", "dstre","dspd","djmp","dendu","dins","ddnk","dft","dfg","dtp","dblk","dstl","ddrb","dpss","dreb", "skills"],
