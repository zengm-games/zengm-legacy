...
define(["db", "globals", "ui", "util/helpers", "util/random"], function (db, g, ui, helpers, random) {
    ...
    activities = [
        ...
        "running my baseball team (baseball is a religion, football is a game)",
        ...
        "buying cars and jewellery for middle school baseball prospects so they'll sign here when they turn pro",
        ...
        "working on how to milk more money from fans by charging admission to training camp workouts. All the other teams will be able to watch as well, but I'm sure you can handle it. Right?",
        "reselling some old food from that grocery chain that went out of business last year. Got it cheap (real cheap). I wouldn't touch this stuff with a ten foot pole, but our fans would eat anything",
        "just polishing up my contracts to ensure my employees have completely waived their rights to sue me.",
        "buying a local sports radio station. Remember, when all else fails, buy your critics off or sue them into the ground.",
        "suing a local newspaper. Remember, when all else fails, buy your critics off or sue them into the ground.",
        "trying to convince the ratings agencies to stop calling my bonds junk. Don't they know that makes it harder to get even more money?"
    ];
    ...
    wins[0] = [
        ...
        "I'm not going to fire your coach yet for losing, because I owe him too much. However, I may start calling plays for him until he leaves."
    ];
    wins[1] = [
    ...
    playoffs[4] = [
        ...
        "I need some more jewellery. Go get me another ring."
    ];
