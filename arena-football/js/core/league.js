				...
				db.setGameAttributes(gameAttributes, function() {
					...
					player.genBaseMoods(tx, function(baseMoods) {
						...
						if (leagueFile.hasOwnProperty("players")) {
							...
							baseRatings = [37, 37, 36, 35, 34, 33, 32, 31, 30, 29, 28, 26, 26, 26, 37, 37, 36, 35, 34, 33];
							...
							pots = [75, 85, 85, 75, 70, 90, 70, 90, 75, 80, 90, 85, 75, 85, 75, 85, 70, 80, 90, 90];
