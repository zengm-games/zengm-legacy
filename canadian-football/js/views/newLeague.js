    ...
    function uiFirst(vm) {
        ...
        updatePopText = function () {
            ...
            if (team.tid() >= 0) {
                ...
                } else if (team.popRank() <= 4) {
                    difficulty = "easy";
                } else if (team.popRank() <= 8) {
                    difficulty = "normal";
                } else if (team.popRank() <= 9) {
                    difficulty = "hard";
                } else {
                    difficulty = "very hard";
                }
                document.getElementById("pop-text").innerHTML = "Region Difficulty: " + team.pop() + " (high=easier) , #" + team.popRank() + " leaguewide";
            } else {
//                document.getElementById("pop-text").innerHTML = "Region population: ?<br>Difficulty: ?";
                document.getElementById("pop-text").innerHTML = "Region Difficulty: ?";
            }
...
//                document.getElementById("pop-text").innerHTML = "Region population: " + team.pop() + " million, #" + team.popRank() + " leaguewide";
//                document.getElementById("pop-text").innerHTML = "Difficulty: " + team.pop() + ", #" + team.popRank() + " leaguewide (#10 is hardest, #1 easiest)";
            } else {
//                document.getElementById("pop-text").innerHTML = "Region population: ?<br>Difficulty: ?";
                document.getElementById("pop-text").innerHTML = "Region population: ?";
//                document.getElementById("pop-text").innerHTML = "Difficulty: ?";
            }*/
        };
