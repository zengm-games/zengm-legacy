...
/////////////////// kicker			
            ...
            for (i = 24; i < 26; i++) {			
				...
				if (((players[i].pos != "K") && (players[i].pos != "P")) && ((i>23) && (i<26))) {
					for (k = (i+1); k < players.length; k++) {
						//console.log("pos: "+ players[k].pos);
