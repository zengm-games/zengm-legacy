...
define(["dao", "globals", "ui", "core/finances", "core/league", "core/player", "core/team", "lib/faces", "lib/knockout", "lib/knockout.mapping", "util/bbgmView", "util/helpers"], function (dao, g, ui, finances, league, player, team, faces, ko, komapping, bbgmView, helpers) {
    ...
    function updateCustomizePlayerChampions(inputs, updateEvents) {
        if (updateEvents.indexOf("firstRun") >= 0) {
            return team.filter({
                attrs: ["tid", "region", "name"],
                season: g.season
            }).then(function (teams) {
                var i, positions, seasonOffset, vars,country;
    ...
    return bbgmView.init({
        id: "customizePlayerChampions",
        get: get,
        InitViewModel: InitViewModel,
        mapping: mapping,
        runBefore: [updateCustomizePlayerChampions],
        uiFirst: uiFirst
    });
});