...
//                pot = Math.round(helpers.bound(random.realGauss(48, 17), baseRating, 90));  //4 SUP
//                pot = Math.round(helpers.bound(random.realGauss(48, 34), baseRating, 90)); // 9 SUP
//                pot = Math.round(helpers.bound(random.realGauss(48, 34), baseRating, 90)); // 9 SUP
//                pot = Math.round(helpers.bound(random.realGauss(55, 34), baseRating, 100)); // 8 SUP
//                pot = Math.round(helpers.bound(random.realGauss(48, 34), baseRating, 90))+10;
//                pot = Math.round(helpers.bound(random.realGauss(48, 34), baseRating, 90))+15;
//                pot = Math.round(helpers.bound(random.realGauss(48, 34), baseRating, 90))+15;
//console.log(baseRating+" "+pot);
