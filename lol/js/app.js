...
require(["db", "views", "ui", "data/changes", "lib/davis", "util/account", "util/helpers", "lib/bluebird", "lib/bootstrap-affix", "lib/bootstrap-alert", "lib/bootstrap-collapse", "lib/bootstrap-dropdown", "lib/bootstrap-modal", "lib/bootstrap-popover", "lib/davis.google_analytics","lib/IndexedDB-getAll-shim", "lib/jquery.barGraph", "lib/jquery.dataTables", "lib/jquery.dataTables.bbgmSorting", "lib/jquery.dataTables.bootstrap", "lib/jquery-ui", "lib/jquery-ui.touch-punch", "util/templateHelpers", "api"], function (db, views, ui, changes, Davis, account, helpers) {
    ...
    if (typeof indexedDB === "undefined") { // Some browsers don't like just plain "indexedDB === undefined"
        errorMsg = '<p>Your browser is not modern enough to run LOL GM. <a href="http://www.firefox.com/">Mozilla Firefox</a> and <a href="http://www.google.com/chrome/">Google Chrome</a> work best.</p>';
        ...
        if (/(iPad|iPhone|iPod)/.test(navigator.userAgent)) {
            errorMsg += '<p>If you\'re on an iPhone/iPad/iPod, there is currently no way to run LOL GM. Please come back on a desktop/laptop or a non-Apple mobile device!</p>';
        }
    ...
    if (navigator.userAgent.indexOf("Safari") >= 0 && navigator.userAgent.indexOf("Chrome") < 0) {
        ...
        // Special error for Apple's mobile devices, as that's the only platform that is totally unsupported (no alternative browser to install)
        if (/(iPad|iPhone|iPod)/.test(navigator.userAgent)) {
            errorMsg += '<p>If you\'re on an iPhone/iPad/iPod, there is currently no way to run LOL GM. Please come back on a desktop/laptop or a non-Apple mobile device! And complain to Apple to fix IndexedDB if you want to play LOL GM on your iDevice.</p>';
        }
...
//        return helpers.error(errorMsg);
    ...
    db.connectMeta().then(function () {
        var app = new Davis(function () {
            ...
            this.get("/l/:lid/edit_champion_info", views.editChampionInfo.get);
            this.post("/l/:lid/edit_champion_info", views.editChampionInfo.post);
            this.get("/l/:lid/edit_champion_patch", views.editChampionPatch.get);
            this.post("/l/:lid/edit_champion_patch", views.editChampionPatch.post);
            ...
            this.get("/l/:lid/customize_player_Champions", views.customizePlayerChampions.get);
            this.get("/l/:lid/customize_player_Champions/:pid", views.customizePlayerChampions.get);
            ...
            this.get("/l/:lid/custom_roster_mode", views.customRosterMode.get);
			this.get("/l/:lid/regional_restrictions", views.regionalRestrictions.get);
