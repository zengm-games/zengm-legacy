...
async function updatePlayers(
    ...
    if ((inputs.season === g.season && updateEvents.includes('playerMovement')) || (updateEvents.includes('newPhase') && g.phase === g.PHASE.PRESEASON) || inputs.season !== state.season || inputs.abbrev !== state.abbrev) {
        let players;
      ...
      //  if (tid < 0) { tid = undefined; } // Show all teams
        ...
        players = await idb.getCopies.playersPlus(players, {
            ...
            ratings: ["MMR","rank","ovr", "pot", "hgt", "stre", "spd", "jmp", "endu", "ins", "dnk", "ft", "fg", "tp", "blk", "stl", "drb", "pss", "reb", "skills", "pos","languages","languagesGrouped"],
            stats: ["abbrev", "tid"],
