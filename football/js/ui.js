 ...
 */
define(["dao", "db", "globals", "templates", "lib/bluebird", "lib/davis", "lib/html2canvas", "lib/jquery", "lib/knockout", "lib/underscore", "util/helpers", "util/lock"], function (dao, db, g, templates, Promise, Davis, html2canvas, $, ko, _, helpers, lock) {
    ...
    function init() {
        var api, playMenu, $playMenuDropdown, playMenuOptions, screenshotEl, topMenuCollapse;
...
console.log(g.vm.multiTeam);
        ...
        if (screenshotEl) { // Some errors were showing up otherwise for people with stale index.html maybe
            screenshotEl.addEventListener("click", function (event) {
                ...
                watermark.innerHTML = '<nav class="navbar navbar-default"><div class="container-fluid"><div class="navbar-header">' +
                    ...
                    '</div><p class="navbar-text navbar-right" style="color: #000; font-weight: bold">Play your own league free at zengm.com</p></div></nav>';
    ...
    function title(text) {
        ...
        document.title = text + " - Football GM";
    }
   ...
   /**
    ...
    function updatePlayMenu(ot) {
        ...
        allOptions = [{id: "play-menu-stop", url: "", label: "Stop"},
                      {id: "play-menu-day", url: "", label: "One week"},
                      {id: "play-menu-week", url: "", label: "Two months"},
                 //     {id: "play-menu-month", url: "", label: "Full Season"},
                      {id: "play-menu-until-playoffs", url: "", label: "Until playoffs"},
                      {id: "play-menu-through-playoffs", url: "", label: "Through playoffs"},
                      {id: "play-menu-day-live", url: helpers.leagueUrl(["live"]), label: "One week (live)"},
