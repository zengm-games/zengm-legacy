    ...
    function updatePlayer(inputs, updateEvents, vm) {
        if (updateEvents.indexOf("dbChange") >= 0 || updateEvents.indexOf("firstRun") >= 0 || !vm.retired()) {
            return Promise.all([
                ...
                p = player.filter(p, {
                    attrs: ["pid", "name", "tid", "abbrev", "teamRegion", "teamName", "pos", "age", "hgtFt", "hgtIn", "weight", "born", "contract", "draft", "face", "mood", "injury", "salaries", "salariesTotal","awards", "awardsGrouped", "freeAgentMood", "imgURL", "watch", "gamesUntilTradable"],
//                    ratings: ["season", "abbrev", "age", "ovr", "pot", "hgt", "stre", "spd", "jmp", "endu", "ins", "dnk", "ft", "fg", "tp", "blk", "stl", "drb", "pss", "reb", "skills"],
                    ratings: ["season", "abbrev", "age", "ovr", "pot", "hgt", "stre", "spd", "jmp", "endu", "hnd","ins", "dnk", "ft", "fg", "tp", "blk", "stl", "drb", "pss", "reb","cvr","kck", "skills"],
                    stats: ["season", "abbrev", "age", "gp", "gs", "min", "fg", "fga", "fgp", "fgAtRim", "fgaAtRim", "fgpAtRim", "fgLowPost", "fgaLowPost", "fgpLowPost", "fgMidRange", "fgaMidRange", "fgpMidRange", "tp", "tpa", "tpp", "ft", "fta", "ftp", "orb", "drb", "trb", "ast", "tov", "stl", "blk", "pf", "pts", "per", "ewa", 'tgts', 'ols', 'olr', 'olp', 'olry', 'olpy', 'olc', 'oltd', 'der', 'dep', 'dery', 'depy', 'dec', 'detd','prp','fdt','fdp','fdr','ty','syl','tda','tdf','rztd','rza','top','fbl','fbll','fblr','fbltd','inter','intery','intertd','pen','peny','qr','qbr','war','warr','warp','warre','ward','warol','wardl','pr','pry','prtd','kr','kry','krtd','kol','koa','koav','koy','rushl','rusha','recl','reca','passa','prl','pra','krl','kra','fgl','fgat','puntl','punta','sackp','tdp','intp','pya','apya','pyc','pyg','bya','abya','ruya','ruag','ruyg','reyc','reyg','recg','reyt','olary','olapy','olrp','olrmp','olrmpg','olrmpa','puntay','fldgp','exptp','fldgze','fldgtw','fldgth','fldgfo','fldgfi','puntty','punttb','fldgzea','fldgtwa','fldgtha','fldgfoa','fldgfia','fldgzep','fldgtwp','fldgthp','fldgfop','fldgfip','dera','depa','derpa','derpag','derpatp'],
                    playoffs: true,
                    showNoStats: true,
                    showRookies: true,
                    fuzz: true
