    ...
    function updateDraftSummary(inputs, updateEvents, vm) {
        ...
        return dao.players.getAll({
            ...
            playersAll = player.filter(playersAll, {
                ...
                stats: ["gp", "min", "pts", "trb", "ast", "per","qbr","ruya","reyc","olrmpa","fgpAtRim","derpatp"],
                showNoStats: true,
                showRookies: true,
                fuzz: true
            });
...
//                if (pa.draft.round === 1 || pa.draft.round === 2) {
                if (pa.draft.round === 1 || pa.draft.round === 2 || pa.draft.round === 3 || pa.draft.round === 4 || pa.draft.round === 5) {
                    // Attributes
