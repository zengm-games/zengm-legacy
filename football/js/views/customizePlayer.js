...
define(["dao", "globals", "ui", "core/finances", "core/league", "core/player", "core/team", "lib/faces", "lib/knockout", "lib/knockout.mapping", "util/bbgmView", "util/helpers"], function (dao, g, ui, finances, league, player, team, faces, ko, komapping, bbgmView, helpers) {
    ...
    function InitViewModel() {
        ...
        this.ratings = {};
        ratingKeys = ["pot", "hgt", "stre", "spd", "jmp", "endu", "ins", "dnk", "ft", "fg", "tp", "blk", "stl", "drb", "pss", "reb","hnd","cvr","kck"];
     ...
     function updateCustomizePlayer(inputs, updateEvents) {
        if (updateEvents.indexOf("firstRun") >= 0) {
            return team.filter({
                ...
                positions = ["QB", "RB", "TE", "WR", "OL", "CB", "S", "LB", "DL","K"];
...
//            p.ratings[r].ovr = player.ovr(p.ratings[r]);
            p.ratings[r].ovr = player.ovrOnly(p.ratings[r],p.pos);
