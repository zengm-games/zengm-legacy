...
define(["dao", "db", "globals", "ui", "core/draft", "core/finances", "core/phase", "core/player", "core/team", "lib/bluebird", "lib/jquery", "lib/underscore", "util/helpers", "util/random"], function (dao, db, g, ui, draft, finances, phase, player, team, Promise, $, _, helpers, random) {
   ...
   // x and y are both arrays of objects with the same length. For each object, any properties in y but not x will be copied over to x.
     ...
     */
//    function create(name, tid, players, teams, startingSeason, randomizeRosters,customRosterMode, cb) {
	...
	//	console.log(customRosterMode);
        // Default teams
        teamsDefault = helpers.getTeamsDefault();

	//	randomizeRosters=true;
...
//                        var afterPlayerCreation, age, agingYears, baseRatings, cbAfterEachPlayer,  draftYear, goodNeutralBad, i, j, n, numLeft, p, pg, players, pots, profile, profiles, randomizeExpiration, simpleDefaults, t, t2, playerTids;
                      //  var  age, agingYears, baseRatings,  draftYear, goodNeutralBad, i, j, n, numLeft, p, pg, players, pots, profile, profiles, randomizeExpiration, simpleDefaults, t, t2, playerTids;
...
//                            for (t = -10; t < teams.length; t++) {
							...
							//	baseRatings = [37-adjustment, 37-adjustment, 36-adjustment, 35-adjustment, 34-adjustment, 33-adjustment, 32-adjustment, 31-adjustment, 30, 29, 28, 26, 26, 26,37, 37, 36, 35, 34, 33, 32, 31, 30, 29, 28, 26, 26, 26,37, 37, 36, 35, 34, 33, 32, 31, 30, 29, 28, 26, 26, 26,37, 37, 36, 35, 34, 33, 32, 31, 30, 29,29];
//                            pots = [75, 65, 55, 55, 60, 50, 70, 40, 55, 50, 60, 60, 45, 45,75, 65, 55, 55, 60, 50, 70, 40, 55, 50, 60, 60, 45, 45,75, 65, 55, 55, 60, 50, 70, 40, 55, 50, 60, 60, 45, 45,75, 65, 55, 55, 60, 50, 70, 40, 55, 50,50 ];
							//	pots = [75, 85, 85, 75, 70, 90, 70, 90, 75, 80, 90, 85, 75, 85,75, 85, 70, 80, 90, 90, 90, 70, 75, 80, 80, 70, 85, 85,75, 75, 75, 85, 90, 80, 70, 80, 75, 70, 70, 80, 85, 75,75, 75, 85, 85, 90, 80, 70, 80, 75, 70,70 ];
...
//                                    agingYears = random.randInt(0, 13);
								...
								//	let agingYears2 = random.randInt(0, 13);
...
//									   adjustment2 += 12;
								...
								//	let baseRating = random.randInt(-3, 3) + 33 + adjustment + adjustment2 ;
									let baseRating = random.randInt(-3, 3) + 22 + adjustment + adjustment2 ;
//									let pot = random.randInt(-10, 10) + 80 + adjustment   ;
//									let pot = random.randInt(-10, 10) + 70 + adjustment   ;
									//let pot = random.randInt(-10, 10) + 65 + adjustment   ;
