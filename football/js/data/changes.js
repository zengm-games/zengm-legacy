...
define(["lib/jquery", "util/eventLog"], function ($, eventLog) {
    ...
    all = [{
        ...
        date: "2016-06-10",
        msg: 'Updated player ratings and gameSim.'
    }, {
        date: "2016-06-10",
        msg: 'New "Custom Roster Mode" significantly improves performance of some <a href="https://www.reddit.com/r/ZenGMFootball/comments/3ki8y9/nfl_roster_json_generator_any_interest/" target="_blank">custom rosters</a>. Enable it by going to Tools > God Mode within a league and then Tools > Custom Roster Mode.'
    }, {
        date: "2016-06-20",
